...
// https://github.com/sharwell/antlr4cs/tree/master/runtime/CSharp/Antlr4.Runtime
...
namespace TestAmbig
{
    class Program
    {
        ...
        {
            //string fn = @"C:\tmp\test.log";
            //TextWriter errStream = new StreamWriter(fn);
            // Redirect standard error stream to file.
            //Console.SetError(errStream);

            //Console.Error.WriteLine("Error Log for Application");

            //var test = Console.IsErrorRedirected;
        ...
        /// <summary>
        /// https://codingcanvas.com/redirecting-standard-error-for-a-net-application/
        /// SetStdHandle first parameter specifies which stream to redirect i.e. –12 is for stderr and –11 for stdout.
        /// </summary>
